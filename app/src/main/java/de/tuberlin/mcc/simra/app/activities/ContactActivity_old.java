...
public class ContactActivity_old extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.contentContact.buttonProjectSite.setOnClickListener(view -> {
            Intent intent = new Intent(ContactActivity_old.this, WebActivity.class);
        ...
        binding.contentContact.buttonFeedback.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                try {
                    ...
                    Toast.makeText(ContactActivity_old.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
                }
