...
public class StartActivity_old extends BaseActivity {
    ...
    public void navigateIfAllPermissionsGranted() {
        ...
        if (!privacyPolicyAccepted()){
            ...
            Log.d(TAG, "else");
            Intent intent = new Intent(StartActivity_old.this, MainActivity.class);
    ...
    public void fireSendErrorDialog() {
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(StartActivity_old.this);
        ...
        alert.setPositiveButton(R.string.yes, (dialog, id) -> {
            ...
            Intent intent = new Intent(StartActivity_old.this, UploadService.class);
    ...
    public void firePrivacyDialogNormalScreen() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(StartActivity_old.this);
        ...
        DialogInterface.OnClickListener positiveButtonListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                writeBooleanToSharedPrefs("Privacy-Policy-Accepted", checkBox.isChecked(), "simraPrefs", StartActivity_old.this);
                writeBooleanToSharedPrefs("Privacy-Policy-Update-Accepted", checkBox.isChecked(), "simraPrefs", StartActivity_old.this);
                PermissionHelper.requestFirstBasePermissionsNotGranted(StartActivity_old.this);
            }
        };
        builder.setPositiveButton(R.string.next, positiveButtonListener);
        builder.setNegativeButton(R.string.close_simra, (dialog, id) -> {
            finish();
            Toast.makeText(StartActivity_old.this, getString(R.string.simra_closed), Toast.LENGTH_LONG).show();
        });
