...
public class StatisticsActivity2 extends AppCompatActivity {
    ...
    TextView toolbarTxt;
    BarChart chart;
    String locale; // manually added
    Profile profile; // manually added
    ...
    private void initializeToolbar() {
        // Logic for toolbar initialization
    ...
    private void updateRidesInfo() {
        // Logic for updating ride information
    ...
    private void initializeChart() {
        // Logic for initializing the chart
