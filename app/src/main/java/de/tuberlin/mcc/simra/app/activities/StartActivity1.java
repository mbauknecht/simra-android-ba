...
public class StartActivity1 extends BaseActivity {
    ...
    // Log tag
    private static final String TAG = "StartActivity1_LOG";
    ...
    public void navigateIfAllPermissionsGranted() {
        ...
        if (!privacyPolicyAccepted()){
            ...
            Log.d(TAG, "else");
            Intent intent = new Intent(StartActivity1.this, MainActivity.class);
            startActivity(intent);
            // Call finish() to prevent going back to StartActivity1,
    ...
    private void startMainActivity() {
        Intent intent = new Intent(StartActivity1.this, MainActivity.class);
        startActivity(intent);
        finish();  // Prevent going back to StartActivity
    }
    ...
    public void fireSendErrorDialog() {
        ...
        AlertDialog.Builder alert = new AlertDialog.Builder(StartActivity1.this);
        ...
        alert.setPositiveButton(R.string.yes, (dialog, id) -> {
            ...
            Intent intent = new Intent(StartActivity1.this, UploadService.class);
    ...
    public void firePrivacyDialogNormalScreen() {
        ...
        AlertDialog.Builder builder = new AlertDialog.Builder(StartActivity1.this);
        ...
        DialogInterface.OnClickListener positiveButtonListener = new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialogInterface, int i) {
                writeBooleanToSharedPrefs("Privacy-Policy-Accepted", checkBox.isChecked(), "simraPrefs", StartActivity1.this);
                writeBooleanToSharedPrefs("Privacy-Policy-Update-Accepted", checkBox.isChecked(), "simraPrefs", StartActivity1.this);
                PermissionHelper.requestFirstBasePermissionsNotGranted(StartActivity1.this);
            }
        };
        builder.setPositiveButton(R.string.next, positiveButtonListener);
        builder.setNegativeButton(R.string.close_simra, (dialog, id) -> {
            finish();
            Toast.makeText(StartActivity1.this, getString(R.string.simra_closed), Toast.LENGTH_LONG).show();
        });
