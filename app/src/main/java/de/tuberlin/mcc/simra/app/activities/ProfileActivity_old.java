...
public class ProfileActivity_old extends AppCompatActivity {
    ...
    public static void startProfileActivityForChooseRegion(Context context) {
        Intent intent = new Intent(context, ProfileActivity_old.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if(getIntent().hasExtra(EXTRA_PROFILE)) {
            ...
            binding.profileContent.profileRegionLinearLayout.setBackground(ContextCompat.getDrawable(ProfileActivity_old.this,R.drawable.profile_region_border));
        } else {
        ...
        binding.profileContent.switchRegion.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                SharedPref.Settings.RegionSetting.setRegionDetectionViaGPSEnabled(binding.profileContent.switchRegion.isChecked(), ProfileActivity_old.this);
                toggleRegionSwitch(regionContentArray);
            }
        });
    ...
    private void toggleRegionSwitch(ArrayList<String> regionContentArray) {
        ...
        if(SharedPref.Settings.RegionSetting.getRegionDetectionViaGPSEnabled(ProfileActivity_old.this)) {
            ...
            binding.profileContent.regionAutomaticButton.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    ...
                    if (!PermissionHelper.hasBasePermissions(ProfileActivity_old.this)) {
                        PermissionHelper.requestFirstBasePermissionsNotGranted(ProfileActivity_old.this);
                    } else {
                        // notify the user if the location service is disabled
                        if (isLocationServiceOff(locationManager)) {
                            new AlertDialog.Builder(ProfileActivity_old.this).setMessage((R.string.locationServiceisOff + " " + R.string.enableToDetectRegion))
                                    .setPositiveButton(android.R.string.ok,
                                            (paramDialogInterface, paramInt) -> ProfileActivity_old.this
                        ...
                        // get the three nearest regions and let the user choose one of them or cancel in an AlertDialog
                            ...
                            try {
                                int[] nearestRegionCodes = nearestRegionsToThisLocation(locationManager.getLastKnownLocation(LocationManager.GPS_PROVIDER).getLatitude(),
                                        ...
                                        ProfileActivity_old.this);
                                String[] nearestRegionNames = getCorrectRegionNames(regionsDecoder(nearestRegionCodes, ProfileActivity_old.this));
                                AlertDialog.Builder builder = new AlertDialog.Builder(ProfileActivity_old.this).setTitle(R.string.nearestRegions);
                                createButtons(builder, nearestRegionNames, regionContentArray, profile, ProfileActivity_old.this);
                                ...
                                npe.printStackTrace();
                                Toast.makeText(ProfileActivity_old.this, R.string.try_later, Toast.LENGTH_SHORT).show();
                            }
                        }
                    }
                }
    ...
    protected void onStop() {
        ...
        profile.region = regionEncoder(selectedRegion, ProfileActivity_old.this);
    ...
    private void createButtons(AlertDialog.Builder builder, String[] nearestRegionNames, ArrayList<String> regionContentArray, Profile profile, ProfileActivity_old context) {
