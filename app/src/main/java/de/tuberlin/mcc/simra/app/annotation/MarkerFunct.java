...
import de.tuberlin.mcc.simra.app.activities.ShowRouteActivity1;
import de.tuberlin.mcc.simra.app.activities.ShowRouteActivity_old;
...
public class MarkerFunct {
    ...
    private ShowRouteActivity1 activity1;
    private ShowRouteActivity_old activity_old;
    ...
    public MarkerFunct(ShowRouteActivity1 activity, DataLog gpsDataLog, IncidentLog incidentLog, int bikeType, int phoneLocation, boolean child, boolean trailer) {
        ...
        // Preload the Icons for event markers
        // (1) Automatically recognized, not yet annotated
        markerAutoGenerated_edit = activity1.getResources().getDrawable(R.drawable.edit_event_blue, null);

        // (2) Custom, not yet annotated
        markerCustom_edit = activity1.getResources().getDrawable(R.drawable.edit_event_green, null);

        // (3) Automatically recognized, annotated
        markerAutoGenerated_ready = activity1.getResources().getDrawable(R.drawable.edited_event_blue, null);

        // (4) Custom, not yet annotated
        markerCustom_ready = activity1.getResources().getDrawable(R.drawable.edited_event_green, null);

        this.state = activity1.state;
    }

    public MarkerFunct(ShowRouteActivity_old activity, DataLog gpsDataLog, IncidentLog incidentLog, int bikeType, int phoneLocation, boolean child, boolean trailer) {
        ...
        // Preload the Icons for event markers
        // (1) Automatically recognized, not yet annotated
        markerAutoGenerated_edit = activity_old.getResources().getDrawable(R.drawable.edit_event_blue, null);

        // (2) Custom, not yet annotated
        markerCustom_edit = activity_old.getResources().getDrawable(R.drawable.edit_event_green, null);

        // (3) Automatically recognized, annotated
        markerAutoGenerated_ready = activity_old.getResources().getDrawable(R.drawable.edited_event_blue, null);

        // (4) Custom, not yet annotated
        markerCustom_ready = activity_old.getResources().getDrawable(R.drawable.edited_event_green, null);

        this.state = activity_old.state;
    }
