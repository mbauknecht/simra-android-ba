...
public class SettingsActivity_old extends BaseActivity {
    ...
    private void loadActivity() {
        ...
        bikeTypeSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                SharedPref.Settings.Ride.BikeType.setBikeType(position, SettingsActivity_old.this);
            }
        ...
        phoneLocationSpinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            @Override
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                SharedPref.Settings.Ride.PhoneLocation.setPhoneLocation(position, SettingsActivity_old.this);
            }
        ...
        binding.importButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(SettingsActivity_old.this).setTitle(R.string.importPromptTitle);
        ...
        binding.exportButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(SettingsActivity_old.this).setTitle(R.string.exportPromptTitle);
        ...
        activityResultLauncher = activityResultLauncher(SettingsActivity_old.this);
        binding.obsButton.setOnClickListener(view ->
        {
            requestBlePermissions(SettingsActivity_old.this, REQUEST_ENABLE_BT);
            BluetoothAdapter mBluetoothAdapter = BluetoothAdapter.getDefaultAdapter();
            if (mBluetoothAdapter == null) {
                // Device does not support Bluetooth
                Toast.makeText(SettingsActivity_old.this, R.string.openbikesensor_bluetooth_incompatible, Toast.LENGTH_LONG)
                        .show();
            } else if (!mBluetoothAdapter.isEnabled()) {
                // Bluetooth is disabled
                showBluetoothNotEnableWarning(activityResultLauncher, SettingsActivity_old.this);
            } else {
        ...
        binding.obsSwitch.setOnCheckedChangeListener((buttonView, isChecked) -> {
            SharedPref.Settings.OpenBikeSensor.setEnabled(isChecked, SettingsActivity_old.this);
        ...
        binding.appVersionTextView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(SettingsActivity_old.this).setTitle(R.string.debugPromptTitle1);
    ...
    private void fireDebugPrompt() {
        androidx.appcompat.app.AlertDialog.Builder builder = new androidx.appcompat.app.AlertDialog.Builder(SettingsActivity_old.this).setTitle(R.string.debugPromptTitle2);
        File[] dirFiles = new File(getBaseFolderPath(SettingsActivity_old.this)).listFiles();
        ...
        builder.setPositiveButton(R.string.upload, new DialogInterface.OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                prepareDebugZip(clicked[0], ridesAndAccEvents, SettingsActivity_old.this);
                Intent intent = new Intent(SettingsActivity_old.this, DebugUploadService.class);
                startService(intent);
                // delete zip.zip after upload is finished
                new File(IOUtils.Directories.getBaseFolderPath(SettingsActivity_old.this) + "zip.zip").deleteOnExit();
            }
        });
        builder.setNegativeButton(R.string.cancel, null);
        builder.show();
    ...
    public void fireIncidentButtonsEnablePrompt() {
        androidx.appcompat.app.AlertDialog.Builder alert = new androidx.appcompat.app.AlertDialog.Builder(SettingsActivity_old.this);
            ...
            registerForActivityResult(new ActivityResultContracts.OpenDocumentTree(),
                    new ActivityResultCallback<Uri>() {
                        ...
                        public void onActivityResult(Uri uri) {
                            boolean successfullyExported = zipTo(SettingsActivity_old.this.getFilesDir().getParent(), uri, SettingsActivity_old.this);
                            if (successfullyExported) {
                                Toast.makeText(SettingsActivity_old.this, R.string.exportSuccessToast, Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(SettingsActivity_old.this, R.string.exportFailToast, Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
    private final ActivityResultLauncher<String[]> importZipFromLocation =
            registerForActivityResult(new ActivityResultContracts.OpenDocument(),
                    new ActivityResultCallback<Uri>() {
                        @Override
                        public void onActivityResult(Uri uri) {
                            boolean successfullyImported = importSimRaData(uri, SettingsActivity_old.this);
                            if (successfullyImported) {
                                Toast.makeText(SettingsActivity_old.this, R.string.importSuccess, Toast.LENGTH_SHORT).show();
                            } else {
                                Toast.makeText(SettingsActivity_old.this, R.string.importFail, Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
}
