...
public class AboutActivity_old extends BaseActivity {
 ...
 /*   ActivityAboutBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.listView.setAdapter(new ArrayAdapter<>(AboutActivity_old.this,
                android.R.layout.simple_list_item_1, items));
        binding.listView.setOnItemClickListener((parent, view, position, id) -> {
            Intent intent = null;
            switch (position) {
                case 0:
                    intent = new Intent(AboutActivity_old.this, WebActivity.class);
                ...
                case 1:
                    ...
                    break;
                case 2:
                    intent = new Intent(AboutActivity_old.this, LicenseActivity.class);
                    break;
                case 3:
                    intent = new Intent(AboutActivity_old.this, CreditsActivity.class);
                    break;
                default:
                    Toast.makeText(AboutActivity_old.this, R.string.notReady, Toast.LENGTH_SHORT).show();
            }
            if (intent != null) {
