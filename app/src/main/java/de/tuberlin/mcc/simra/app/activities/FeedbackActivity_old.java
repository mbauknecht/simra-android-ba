...
public class FeedbackActivity_old extends AppCompatActivity {
 ...
 /*   ActivityFeedbackBinding binding;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.listView.setAdapter(new ArrayAdapter<>(FeedbackActivity_old.this,
                android.R.layout.simple_list_item_1, items));
        binding.listView.setOnItemClickListener((parent, view, position, id) -> {
            Intent intent = null;
            switch (position) {
                case 0:
                    intent = new Intent(FeedbackActivity_old.this, WebActivity.class);
                ...
                case 1:
                    ...
                    try {
                        ...
                        Toast.makeText(FeedbackActivity_old.this, "There are no email clients installed.", Toast.LENGTH_SHORT).show();
                    }
                    break;
                case 2:
                ...
                case 3:
                    ...
                    break;
                default:
                    Toast.makeText(FeedbackActivity_old.this, R.string.notReady, Toast.LENGTH_SHORT).show();
            }
            if (intent != null) {
                startActivity(intent);
            }
